...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration including logo, footer, and hero reference.';
  ...
  attributes: {
    copyrightText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A92025 Analog. All rights reserved.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    favicon: Schema.Attribute.Media;
    footerLinkGroups: Schema.Attribute.Component<'shared.link-group', true>;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Reusable global hero content displayed across all pages.';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    partnerLogos: Schema.Attribute.Relation<
      'manyToMany',
      'api::partner.partner'
    >;
    publishedAt: Schema.Attribute.DateTime;
